...
class HMM(HMM_Meta):
    ...
    def predict(self, probs):
        ...
        predicted_probs = np.dot(self.trans_probs, probs)
    ...
    def update(self, probs, o):
        ...
        for beacon in range(self.n_beacons):
            for state in range(self.n_states):
                updated_probs[state] *= self.obs_probs[beacon, o[beacon], state]
    ...
    def monitor(self, T, observations):
        ...
        for t in range(1, T):
            ...
            monitoring_probs[t] = monitoring_probs[t] / np.sum(monitoring_probs[t])
